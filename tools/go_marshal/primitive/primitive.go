...
// memory.
func CopyInt16In(task marshal.Task, addr usermem.Addr, dst *int16) error {
	var buf Int16
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
	*dst = int16(buf)
	return nil
...
// memory.
func CopyInt16Out(task marshal.Task, addr usermem.Addr, src int16) error {
	srcP := Int16(src)
...
// memory.
func CopyUint16In(task marshal.Task, addr usermem.Addr, dst *uint16) error {
	var buf Uint16
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
...
// memory.
func CopyUint16Out(task marshal.Task, addr usermem.Addr, src uint16) error {
	srcP := Uint16(src)
	return srcP.CopyOut(task, addr)
}
...
// memory.
func CopyInt32In(task marshal.Task, addr usermem.Addr, dst *int32) error {
	var buf Int32
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
...
// memory.
func CopyInt32Out(task marshal.Task, addr usermem.Addr, src int32) error {
	srcP := Int32(src)
	return srcP.CopyOut(task, addr)
}
...
// memory.
func CopyUint32In(task marshal.Task, addr usermem.Addr, dst *uint32) error {
	var buf Uint32
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
...
// memory.
func CopyUint32Out(task marshal.Task, addr usermem.Addr, src uint32) error {
	srcP := Uint32(src)
	return srcP.CopyOut(task, addr)
}
...
// memory.
func CopyInt64In(task marshal.Task, addr usermem.Addr, dst *int64) error {
	var buf Int64
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
...
// memory.
func CopyInt64Out(task marshal.Task, addr usermem.Addr, src int64) error {
	srcP := Int64(src)
	return srcP.CopyOut(task, addr)
}
...
// memory.
func CopyUint64In(task marshal.Task, addr usermem.Addr, dst *uint64) error {
	var buf Uint64
	if err := buf.CopyIn(task, addr); err != nil {
		return err
	}
...
// memory.
func CopyUint64Out(task marshal.Task, addr usermem.Addr, src uint64) error {
	srcP := Uint64(src)
	return srcP.CopyOut(task, addr)
}
