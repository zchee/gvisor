...
type NUDConfigurations struct {
	...
	//
	// TODO(sbalana): Implement this NUD configuration option.
	...
	//
	// TODO(sbalana): Use this option when sending solicited neighbor
	// confirmations to anycast addresses.
	//
	//     "If the Target Address [of a solicited neighbor advertisement] is an
	//     anycast address, the sender SHOULD delay sending a response for a
	//     random time between 0 and MAX_ANYCAST_DELAY_TIME seconds."
	...
	//     Neighbor Solicitation SHOULD be delayed by a random time between 0 and
	//     MAX_ANYCAST_DELAY_TIME to reduce the probability of network
	//     congestion.  Second, the Override flag in Neighbor Advertisements
	//     SHOULD be set to 0, so that when multiple advertisements are received,
	//     the first received advertisement is used rather than the most recently
	//     received advertisement." - RFC 4861 section 7.2.7
	//
	// TODO(sbalana): Use this option when support for proxying neighbor
	// confirmations is added.
	//
	...
	//     necessary." - RFC 4861 section 7.2.8
	...
	//
	// TODO(sbalana): Use this option when a NIC's link-layer address has changed.
